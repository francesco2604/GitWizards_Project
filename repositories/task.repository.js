  ...
  //(id, question, type, answers, correct_answer, student_answer)
    constructor() {
        this._tasks = new Map([
            ...
            [2, new Task(2, 'Quanti anni aveva napoleone alla sua nascita?', Task.TASK_TYPE.SINGLE_ANSWER ,['0','1','9 mesi'], '1', '2')],
            [3, new Task(3, 'Descrivi la teroia della gravitazionalità', Task.TASK_TYPE.OPEN,['0','1','9 mesi'], '', 'é una teoria  molto importantezionale')],
